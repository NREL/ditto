...
def test_regulators():
    ...
    assert m["vreg2_a"].windings[0].voltage_type == 0
    assert m["vreg2_a"].windings[1].voltage_type == 2
...
#    assert m["regulator_vreg2_a"].pt_phase == "A"
    ...
    assert m["regulator_vreg2_a"].windings[0].voltage_type == 0
    assert m["regulator_vreg2_a"].windings[1].voltage_type == 2
    ...
    assert m["vreg2_b"].windings[0].voltage_type == 0
    assert m["vreg2_b"].windings[1].voltage_type == 2
    ...
    assert m["vreg2_b"].windings[1].phase_windings[0].tap_position == 1.1
...
#    assert m["regulator_vreg2_b"].pt_phase == "B"
    ...
    assert m["regulator_vreg2_b"].windings[0].voltage_type == 0
    assert m["regulator_vreg2_b"].windings[1].voltage_type == 2
    ...
    assert m["regulator_vreg2_b"].windings[1].phase_windings[0].tap_position == 1.1
    ...
    assert m["vreg2_c"].windings[0].voltage_type == 0
    assert m["vreg2_c"].windings[1].voltage_type == 2
    ...
    assert m["vreg2_c"].windings[1].phase_windings[0].tap_position == 1.1
...
#    assert m["regulator_vreg2_c"].pt_phase == "C"
    ...
    assert m["regulator_vreg2_c"].windings[0].voltage_type == 0
    assert m["regulator_vreg2_c"].windings[1].voltage_type == 2
    ...
    assert m["regulator_vreg2_c"].windings[1].phase_windings[0].tap_position == 1.1
    ...
    assert m["regxfmr_b18865"].windings[0].voltage_type == 0
    assert m["regxfmr_b18865"].windings[1].voltage_type == 2
    ...
    assert m["regxfmr_b18865"].windings[1].phase_windings[0].tap_position == 2.0
...
#    assert m["regulator_regxfmr_b18865_ctrl"].pt_phase == "C"
    ...
    assert m["regulator_regxfmr_b18865_ctrl"].windings[0].voltage_type == 0
    assert m["regulator_regxfmr_b18865_ctrl"].windings[1].voltage_type == 2
    ...
    assert m["regxfmr_b18865_2"].windings[0].voltage_type == 0
    assert m["regxfmr_b18865_2"].windings[1].voltage_type == 2
    ...
    assert m["regxfmr_b18865_2"].windings[1].phase_windings[0].tap_position == 1.1
    ...
    assert (
        m["regulator_regxfmr_b18865_2_ctrl"].name == "regulator_regxfmr_b18865_2_ctrl"
    )
...
#    assert m["regulator_regxfmr_b18865_2_ctrl"].pt_phase == "C"
    ...
    assert m["regulator_regxfmr_b18865_2_ctrl"].windings[0].voltage_type == 0
    assert m["regulator_regxfmr_b18865_2_ctrl"].windings[1].voltage_type == 2
    ...
    assert m["sb5_p4uhs0_4_trans_439"].windings[1].phase_windings[0].tap_position == 1.1
    assert m["sb5_p4uhs0_4_trans_439"].windings[1].phase_windings[1].tap_position == 1.1
    assert m["sb5_p4uhs0_4_trans_439"].windings[1].phase_windings[2].tap_position == 1.1
...
#    assert m["regulator_sb5_p4uhs0_4_reg_439"].pt_phase == "A"
    ...
    assert (
        m["regulator_sb5_p4uhs0_4_reg_439"].windings[0].phase_windings[1].tap_position
        == 1.0
    )
    assert (
        m["regulator_sb5_p4uhs0_4_reg_439"].windings[0].phase_windings[2].tap_position
        == 1.0
    )
    ...
    assert m["trans_reg_creduladortension"].reactances == pytest.approx(
    ...
    assert m["trans_reg_creduladortension"].windings[0].voltage_type == 0
    assert m["trans_reg_creduladortension"].windings[1].voltage_type == 2
...
#    assert m["regulator_reg_creguladortension"].pt_phase == "A"
    ...
    assert (
        m["regulator_reg_creguladortension"].windings[0].emergency_power == 15000000.0
    )
    assert (
        m["regulator_reg_creguladortension"].windings[1].emergency_power == 15000000.0
    )
    ...
    assert m["regulator_reg_creguladortension"].windings[0].voltage_type == 0
    assert m["regulator_reg_creguladortension"].windings[1].voltage_type == 2
    ...
    assert m["reg1"].windings[1].phase_windings[0].tap_position == 1.1
...
#    assert m["regulator_reg1"].pt_phase == "A"
    ...
    assert m["regulator_reg1"].windings[0].voltage_type == 0
    assert m["regulator_reg1"].windings[1].voltage_type == 2
    ...
    assert m["regulator_reg1"].windings[1].phase_windings[0].tap_position == 1.1
    ...
    assert m["reg2"].windings[0].voltage_type == 0
    assert m["reg2"].windings[1].voltage_type == 2
    ...
    assert m["reg2"].windings[1].phase_windings[0].tap_position == 1.1
...
#    assert m["regulator_reg2"].pt_phase == "B"
    ...
    assert m["regulator_reg2"].windings[0].voltage_type == 0
    assert m["regulator_reg2"].windings[1].voltage_type == 2
    ...
    assert m["regulator_reg2"].windings[1].phase_windings[0].tap_position == 1.1
    ...
    assert m["reg3"].windings[0].voltage_type == 0
    assert m["reg3"].windings[1].voltage_type == 2
    ...
    assert m["reg3"].windings[1].phase_windings[0].tap_position == 1.1
...
#    assert m["regulator_reg3"].pt_phase == "C"
    ...
    assert m["regulator_reg3"].windings[0].voltage_type == 0
    assert m["regulator_reg3"].windings[1].voltage_type == 2
    ...
    assert m["regulator_reg3"].windings[1].phase_windings[0].tap_position == 1.1
