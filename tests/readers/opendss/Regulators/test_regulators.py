...
def test_regulators():
    ...
    assert m["regulator_vreg2_a"].ltc == None
    #    assert m["regulator_vreg2_a"].positions == None # []
    assert m["regulator_vreg2_a"].ltc == None
    #    assert m["regulator_vreg2_a"].substation_name == None # ''
    assert m["regulator_vreg2_a"].feeder_name == "sourcebus_src"
    assert m["regulator_vreg2_a"].is_substation == 0
    ...
    assert m["regulator_vreg2_b"].ltc == None
    #    assert m["regulator_vreg2_b"].positions == None # []
    assert m["regulator_vreg2_b"].ltc == None
    #    assert m["regulator_vreg2_b"].substation_name == None # ''
    assert m["regulator_vreg2_b"].feeder_name == "sourcebus_src"
    assert m["regulator_vreg2_b"].is_substation == 0
    ...
    assert m["regulator_vreg2_c"].ltc == None
    #    assert m["regulator_vreg2_c"].positions == None # []
    assert m["regulator_vreg2_c"].ltc == None
    #    assert m["regulator_vreg2_c"].substation_name == None # ''
    assert m["regulator_vreg2_c"].feeder_name == "sourcebus_src"
    assert m["regulator_vreg2_c"].is_substation == 0
    ...
    assert m["regxfmr_b18865"].is_substation == 0
    # assert m["regxfmr_b18865"].normhkva == None # 11000.0
    assert m["regxfmr_b18865"].install_type == None
    ...
    #    assert m["regxfmr_b18865"].positions == None # []
    assert m["regxfmr_b18865"].is_center_tap == 0
    #    assert m["regxfmr_b18865"].substation_name == None # ''
    ...
    assert m["regulator_regxfmr_b18865_ctrl"].ltc == None
    #    assert m["regulator_regxfmr_b18865_ctrl"].positions == None # []
    assert m["regulator_regxfmr_b18865_ctrl"].ltc == None
    #    assert m["regulator_regxfmr_b18865_ctrl"].substation_name == None # ''
    assert m["regulator_regxfmr_b18865_ctrl"].feeder_name == "sourcebus_src"
    assert m["regulator_regxfmr_b18865_ctrl"].is_substation == 0
    ...
    assert m["regulator_sb5_p4uhs0_4_reg_439"].ltc == None
    #    assert m["regulator_sb5_p4uhs0_4_reg_439"].positions == None # []
    assert m["regulator_sb5_p4uhs0_4_reg_439"].ltc == None
    #    assert m["regulator_sb5_p4uhs0_4_reg_439"].substation_name == None # ''
    assert m["regulator_sb5_p4uhs0_4_reg_439"].feeder_name == "sourcebus_src"
    assert m["regulator_sb5_p4uhs0_4_reg_439"].is_substation == 0
    ...
    assert m["trans_reg_creduladortension"].is_substation == 0
    # assert m["trans_reg_creduladortension"].normhkva == None # 11000.0
    assert m["trans_reg_creduladortension"].install_type == None
    ...
    #    assert m["trans_reg_creduladortension"].positions == None # []
    assert m["trans_reg_creduladortension"].is_center_tap == 0
    #    assert m["trans_reg_creduladortension"].substation_name == None # ''
    ...
    # assert m["regulator_reg_creguladortension"].connected_transformer == "trans_reg_creduladortension"
    ...
    assert m["regulator_reg_creguladortension"].ltc == None
    #    assert m["regulator_reg_creguladortension"].positions == None # []
    assert m["regulator_reg_creguladortension"].ltc == None
    #    assert m["regulator_reg_creguladortension"].substation_name == None # ''
    assert m["regulator_reg_creguladortension"].feeder_name == "sourcebus_src"
    assert m["regulator_reg_creguladortension"].is_substation == 0
    ...
    assert m["regulator_reg1"].ltc == None
    #    assert m["regulator_reg1"].positions == None # []
    assert m["regulator_reg1"].ltc == None
    #    assert m["regulator_reg1"].substation_name == None # ''
    assert m["regulator_reg1"].feeder_name == "sourcebus_src"
    assert m["regulator_reg1"].is_substation == 0
    ...
    assert m["regulator_reg2"].ltc == None
    #    assert m["regulator_reg2"].positions == None # []
    assert m["regulator_reg2"].ltc == None
    #    assert m["regulator_reg2"].substation_name == None # ''
    assert m["regulator_reg2"].feeder_name == "sourcebus_src"
    assert m["regulator_reg2"].is_substation == 0
    ...
    assert m["regulator_reg3"].ltc == None
    #    assert m["regulator_reg3"].positions == None # []
    assert m["regulator_reg3"].ltc == None
    #    assert m["regulator_reg3"].substation_name == None # ''
    assert m["regulator_reg3"].feeder_name == "sourcebus_src"
    assert m["regulator_reg3"].is_substation == 0
