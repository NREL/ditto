...
def test_transformer_kv():
    ...
    #    assert m["substation"].noload_loss == None # 0.0
    #    assert m["substation"].loadloss == None # 0.001
    assert m["substation"].phase_shift == None
    # assert m["substation"].is_substation == 0  # Not implemented for now
    #    assert m["substation"].normhkva == None # 5500.0
    # assert m["substation"].install_type == None # Not implemented for now
    assert m["substation"].from_element == "sourcebus"
    assert m["substation"].to_element == "bus1"
    #    assert m["substation"].reactances == None # 0.008
    #    assert m["substation"].positions == None # [] # Not implemented for now
    assert m["substation"].is_center_tap == 0
    #    assert m["substation"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["substation"].windings[0].emergency_power == None # 7500000.0
    #    assert m["substation"].windings[1].emergency_power == None # 7500000.0
    ...
    #    assert m["substation"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["substation"].windings[0].phase_windings[1].tap_position == None # 1.0
    #    assert m["substation"].windings[0].phase_windings[2].tap_position == None # 1.0

    #    assert m["substation"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["substation"].windings[1].phase_windings[1].tap_position == None # 1.0
    #    assert m["substation"].windings[1].phase_windings[2].tap_position == None # 1.0
    ...
    #    assert m["reg1"].reactances == None # 7.0
    ...
    #    assert m["reg1"].windings[0].connection_type == None # Y
    #    assert m["reg1"].windings[1].connection_type == None # Y
    ...
    #    assert m["reg1"].windings[0].resistance == None # 0.2
    #    assert m["reg1"].windings[1].resistance == None # 0.2
    ...
    #    assert m["reg1"].windings[0].phase_windings[1].tap_position == None # 1.0
    #    assert m["reg1"].windings[0].phase_windings[2].tap_position == None # 1.0
    ...
    #    assert m["xfm1"].noload_loss == None # 0.0 #loadloss or noloadloss?
    #    assert m["xfm1"].loadloss == None # 1.1, loadloss or noloadloss?
    assert m["xfm1"].phase_shift == None
    # assert m["xfm1"].is_substation == 0 # Not implemented for now
    #    assert m["xfm1"].normhkva == None # 550.0
    # assert m["xfm1"].install_type == None # Not implemented for now
    assert m["xfm1"].from_element == "bus2"
    assert m["xfm1"].to_element == "bus3"
    assert m["xfm1"].reactances == [float(2)]
    #    assert m["xfm1"].positions == None # [] # Not implemented for now
    assert m["xfm1"].is_center_tap == 0
    #    assert m["xfm1"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["xfm1"].windings[0].emergency_power == None # 750000.0
    #    assert m["xfm1"].windings[1].emergency_power == None # 750000.0
    ...
    #    assert m["xfm1"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["xfm1"].windings[0].phase_windings[1].tap_position == None # 1.0

    #    assert m["xfm1"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["xfm1"].windings[1].phase_windings[1].tap_position == None # 1.0
    ...
    #    assert m["t1"].noload_loss == None # 0.0 #loadloss or noloadloss?
    #    assert m["t1"].loadloss == None # 1.0, loadloss or noloadloss?
    assert m["t1"].phase_shift == None
    # assert m["t1"].is_substation == 0 # Not implemented for now
    #    assert m["t1"].normhkva == None # 6600.0
    # assert m["t1"].install_type == None # Not implemented for now
    assert m["t1"].from_element == "n2"
    assert m["t1"].to_element == "n3"
    assert m["t1"].reactances == [float(6)]
    #    assert m["t1"].positions == None # [] # Not implemented for now
    assert m["t1"].is_center_tap == 0
    #    assert m["t1"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["t1"].windings[0].emergency_power == None # 9000000.0
    #    assert m["t1"].windings[1].emergency_power == None # 9000000.0
    ...
    #    assert m["t1"].windings[0].phase_windings[0].tap_position == None # 1.0

    #    assert m["t1"].windings[1].phase_windings[0].tap_position == None # 1.0

    #    assert m["t1"].windings[0].phase_windings[0].phase == "C" # Assumed it is phase 3

    #    assert m["t1"].windings[1].phase_windings[0].phase == "C" # Assumed it is phase 3
    ...
    #    assert m["sb5_p4uhs0_4_trans_439"].windings[0].phase_windings[1].tap_position == None # 1.0
    #    assert m["sb5_p4uhs0_4_trans_439"].windings[0].phase_windings[2].tap_position == None # 1.0
    ...
    # assert m["tr(r:p4udt27-p4udt27lv)"].is_substation == 0 # Not implemented for now
    #    assert m["tr(r:p4udt27-p4udt27lv)"].normhkva == 82.5
    # assert m["tr(r:p4udt27-p4udt27lv)"].install_type == None # Not implemented for now
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)"].positions == None # [] # Not implemented for now
    assert m["tr(r:p4udt27-p4udt27lv)"].is_center_tap == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)"].windings[0].phase_windings[1].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)"].windings[0].phase_windings[2].tap_position == None # 1.0

    #    assert m["tr(r:p4udt27-p4udt27lv)"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)"].windings[1].phase_windings[1].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)"].windings[1].phase_windings[2].tap_position == None # 1.0
    ...
    # assert m["tr(r:p4udt27-p4udt27lv)_1"].is_substation == 0 # Not implemented for now
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].normhkva == 82.5
    # assert m["tr(r:p4udt27-p4udt27lv)_1"].install_type == None # Not implemented for now
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].positions == None # [] # Not implemented for now
    assert m["tr(r:p4udt27-p4udt27lv)_1"].is_center_tap == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].windings[0].phase_windings[1].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].windings[0].phase_windings[2].tap_position == None # 1.0

    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].windings[1].phase_windings[1].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].windings[1].phase_windings[2].tap_position == None # 1.0
    ...
    # assert m["tr(r:p4udt27-p4udt27lv)_2"].is_substation == 0 # Not implemented for now
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].normhkva == 82.5
    # assert m["tr(r:p4udt27-p4udt27lv)_2"].install_type == None # Not implemented for now
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].positions == None # [] # Not implemented for now
    assert m["tr(r:p4udt27-p4udt27lv)_2"].is_center_tap == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].windings[0].phase_windings[1].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].windings[0].phase_windings[2].tap_position == None # 1.0

    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].windings[1].phase_windings[1].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].windings[1].phase_windings[2].tap_position == None # 1.0
    ...
    # assert m["tr(r:p4udt27-p4udt27lv)_3"].is_substation == 0 # Not implemented for now
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].normhkva == 82.5
    # assert m["tr(r:p4udt27-p4udt27lv)_3"].install_type == None # Not implemented for now
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].positions == None # [] # Not implemented for now
    assert m["tr(r:p4udt27-p4udt27lv)_3"].is_center_tap == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].windings[0].phase_windings[1].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].windings[0].phase_windings[2].tap_position == None # 1.0

    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].windings[1].phase_windings[1].tap_position == None # 1.0
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].windings[1].phase_windings[2].tap_position == None # 1.0
    ...
    # assert m["tr(r:p4udt25-p4udt25lv)"].is_substation == 0 # Not implemented for now
    assert m["tr(r:p4udt25-p4udt25lv)"].normhkva == 27.5
    # assert m["tr(r:p4udt25-p4udt25lv)"].install_type == None # Not implemented for now
    assert m["tr(r:p4udt25-p4udt25lv)"].from_element == "p4udt25"
    assert m["tr(r:p4udt25-p4udt25lv)"].to_element == "p4udt25lv"
    # assert m["tr(r:p4udt25-p4udt25lv)"].reactances == [float(2.4)]
    # assert m["tr(r:p4udt25-p4udt25lv)"].positions == None # [] # Not implemented for now
    assert m["tr(r:p4udt25-p4udt25lv)"].is_center_tap == 1
    # assert m["tr(r:p4udt25-p4udt25lv)"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["tr(r:p4udt25-p4udt25lv)"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt25-p4udt25lv)"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["tr(r:p4udt25-p4udt25lv)"].windings[2].phase_windings[0].tap_position == None # 1.0
    ...
    #    assert m["t21396254a"].loadloss == None # 1.8
    assert m["t21396254a"].phase_shift == None
    # assert m["t21396254a"].is_substation == 0 # Not implemented for now
    #    assert m["t21396254a"].normhkva == None # 16.5
    # assert m["t21396254a"].install_type == None # Not implemented for now
    assert m["t21396254a"].from_element == "l2804253"
    assert m["t21396254a"].to_element == "x2804253a"
    #    assert m["t21396254a"].reactances == [float(2.4)] # [2.04, 2.04, 1.36]
    # assert m["t21396254a"].positions == None # [] # Not implemented for now
    assert m["t21396254a"].is_center_tap == 1
    # assert m["t21396254a"].substation_name == '' # Not implemented for now

    #    assert m["t21396254a"].windings[0].connection_type == None # Y
    #    assert m["t21396254a"].windings[1].connection_type == None # Y
    #    assert m["t21396254a"].windings[2].connection_type == None # Y
    ...
    #    assert m["t21396254a"].windings[0].emergency_power == None # 22500.0
    #    assert m["t21396254a"].windings[1].emergency_power == None # 22500.0
    #    assert m["t21396254a"].windings[2].emergency_power == None # 22500.0
    ...
    #    assert m["t21396254a"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["t21396254a"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["t21396254a"].windings[2].phase_windings[0].tap_position == None # 1.0
    ...
    #    assert m["feeder_rega"].noload_loss == None # 0.0
    assert m["feeder_rega"].loadloss == 0.001
    assert m["feeder_rega"].phase_shift == None
    # assert m["feeder_rega"].is_substation == 0 # Not implemented for now
    #    assert m["feeder_rega"].normhkva == None # 30250.0
    # assert m["feeder_rega"].install_type == None # Not implemented for now
    ...
    # assert m["feeder_rega"].positions == None # [] # Not implemented for now
    assert m["feeder_rega"].is_center_tap == 0
    # assert m["feeder_rega"].substation_name == None # '' # Not implemented for now

    # assert m["feeder_rega"].windings[0].connection_type == None # Y
    # assert m["feeder_rega"].windings[1].connection_type == None # Y

    assert m["feeder_rega"].windings[0].rated_power == 27500 * 10 ** 3
    assert m["feeder_rega"].windings[1].rated_power == 27500 * 10 ** 3

    #    assert m["feeder_rega"].windings[0].emergency_power == None # 41250000.0
    #    assert m["feeder_rega"].windings[1].emergency_power == None # 41250000.0

    #    assert m["feeder_rega"].windings[0].resistance == None # 0.0005
    #    assert m["feeder_rega"].windings[1].resistance == None # 0.0005
    ...
    #    assert m["feeder_rega"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["feeder_rega"].windings[1].phase_windings[0].tap_position == None # 1.0
    ...
    # assert m["b13659-1c"].is_substation == 0 # Not implemented for now
    assert m["b13659-1c"].normhkva == 15
    # assert m["b13659-1c"].install_type == None # Not implemented for now
    assert m["b13659-1c"].from_element == "b13659"
    assert m["b13659-1c"].to_element == "x_b13659-c"
    assert m["b13659-1c"].reactances == [1.5]
    # assert m["b13659-1c"].positions == None # [] # Not implemented for now
    assert m["b13659-1c"].is_center_tap == 0
    # assert m["b13659-1c"].substation_name == None # '' # Not implemented for now

    assert m["b13659-1c"].windings[0].connection_type == "Y"
    assert m["b13659-1c"].windings[1].connection_type == "Y"
    ...
    #    assert m["b13659-1c"].windings[0].resistance == None # 0.52
    #    assert m["b13659-1c"].windings[1].resistance == None # 0.52
    ...
    #    assert m["b13659-1c"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["b13659-1c"].windings[1].phase_windings[0].tap_position == None # 1.0
    ...
    # assert m["b4551-1a"].is_substation == 0 # Not implemented for now
    assert m["b4551-1a"].normhkva == 15
    # assert m["b4551-1a"].install_type == None # Not implemented for now
    assert m["b4551-1a"].from_element == "b4551"
    assert m["b4551-1a"].to_element == "x_b4551-a"
    assert m["b4551-1a"].reactances == [1.5]
    # assert m["b4551-1a"].positions == None # [] # Not implemented for now
    assert m["b4551-1a"].is_center_tap == 0
    # assert m["b4551-1a"].substation_name == None # '' # Not implemented for now

    # assert m["b4551-1a"].windings[0].connection_type == None # Y
    # assert m["b4551-1a"].windings[1].connection_type == None # Y
    ...
    #    assert m["b4551-1a"].windings[0].resistance == None # 0.52
    #    assert m["b4551-1a"].windings[1].resistance == None # 0.52
    ...
    #    assert m["b4551-1a"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["b4551-1a"].windings[1].phase_windings[0].tap_position == None # 1.0
    ...
    # assert m["5865228330a-1abc"].is_substation == 0 # Not implemented for now
    assert m["5865228330a-1abc"].normhkva == 2000.01
    # assert m["5865228330a-1abc"].install_type == None # Not implemented for now
    ...
    #    assert m["5865228330a-1abc"].positions == None # [] # Not implemented for now
    assert m["5865228330a-1abc"].is_center_tap == 0
    #    assert m["5865228330a-1abc"].substation_name == None # '' # Not implemented for now

    # assert m["5865228330a-1abc"].windings[0].connection_type == None # Y
    # assert m["5865228330a-1abc"].windings[1].connection_type == None # Y
    ...
    # assert m["5865228330a-1abc"].windings[0].resistance == None # 0.35
    # assert m["5865228330a-1abc"].windings[1].resistance == None # 0.35
    ...
    #    assert m["5865228330a-1abc"].windings[0].phase_windings[0].tap_position == None # 1.0
    #    assert m["5865228330a-1abc"].windings[0].phase_windings[1].tap_position == None # 1.0
    #    assert m["5865228330a-1abc"].windings[0].phase_windings[2].tap_position == None # 1.0

    #    assert m["5865228330a-1abc"].windings[1].phase_windings[0].tap_position == None # 1.0
    #    assert m["5865228330a-1abc"].windings[1].phase_windings[1].tap_position == None # 1.0
    #    assert m["5865228330a-1abc"].windings[1].phase_windings[2].tap_position == None # 1.0
    ...
    #    assert m["t1_1"].noload_loss == None # 0.0 #loadloss or noloadloss?
    #    assert m["t1_1"].loadloss == None # 1.0, loadloss or noloadloss?
    assert m["t1_1"].phase_shift == None
    # assert m["t1_1"].is_substation == 0 # Not implemented for now
    #    assert m["t1_1"].normhkva == None # 6600.0
    # assert m["t1_1"].install_type == None # Not implemented for now
    assert m["t1_1"].from_element == "n2"
    assert m["t1_1"].to_element == "n3"
    assert m["t1_1"].reactances == [float(6)]
    #    assert m["t1_1"].positions == None # [] # Not implemented for now
    assert m["t1_1"].is_center_tap == 0
    #    assert m["t1_1"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["t1_1"].windings[0].emergency_power == None # 9000000.0
    #    assert m["t1_1"].windings[1].emergency_power == None # 9000000.0
    ...
    #    assert m["t1_1"].windings[0].phase_windings[0].tap_position == None # 1.0

    #    assert m["t1_1"].windings[1].phase_windings[0].tap_position == None # 1.0

    #    assert m["t1_1"].windings[0].phase_windings[0].phase == "C" # Assumed it is phase 3
    #    assert m["t1_1"].windings[1].phase_windings[0].phase == "C" # Assumed it is phase 3
    ...
    #    assert m["t1_2"].noload_loss == None # 0.0 #loadloss or noloadloss?
    #    assert m["t1_2"].loadloss == None # 1.0, loadloss or noloadloss?
    assert m["t1_2"].phase_shift == None
    # assert m["t1_2"].is_substation == 0 # Not implemented for now
    #    assert m["t1_2"].normhkva == None # 6600.0
    # assert m["t1_2"].install_type == None # Not implemented for now
    assert m["t1_2"].from_element == "n2"
    assert m["t1_2"].to_element == "n3"
    assert m["t1_2"].reactances == [float(6)]
    #    assert m["t1_2"].positions == None # [] # Not implemented for now
    assert m["t1_2"].is_center_tap == 0
    #    assert m["t1_2"].substation_name == None # '' # Not implemented for now
    ...
    #    assert m["t1_2"].windings[0].emergency_power == None # 9000000.0
    #    assert m["t1_2"].windings[1].emergency_power == None # 9000000.0
    ...
    #    assert m["t1_2"].windings[0].phase_windings[0].tap_position == None # 1.0

    #    assert m["t1_2"].windings[1].phase_windings[0].tap_position == None # 1.0

    #    assert m["t1_2"].windings[0].phase_windings[0].phase == "C" # Assumed it is phase 3
    #    assert m["t1_2"].windings[1].phase_windings[0].phase == "C" # Assumed it is phase 3
