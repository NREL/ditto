...
def test_transformer_kv():
    ...
    assert m["t1"].is_substation == 0
    #    assert m["t1"].normhkva == None # 6600.0
    assert m["t1"].install_type == None
    assert m["t1"].from_element == "n2"
    assert m["t1"].to_element == "n3"
    assert m["t1"].reactances == [float(6)]
    #    assert m["t1"].positions == None # []
    assert m["t1"].is_center_tap == 0
    #    assert m["t1"].substation_name == None # ''

    assert m["t1"].windings[0].connection_type == "Y"
    #    assert m["t1"].windings[1].connection_type == "Y" # Connection is mentioned as Delta
    ...
    assert m["sb5_p4uhs0_4_trans_439"].is_substation == 0
    #    assert m["sb5_p4uhs0_4_trans_439"].normhkva == None # 8800.0
    assert m["sb5_p4uhs0_4_trans_439"].install_type == None
    ...
    #    assert m["sb5_p4uhs0_4_trans_439"].positions == None # []
    assert m["sb5_p4uhs0_4_trans_439"].is_center_tap == 0
    #    assert m["sb5_p4uhs0_4_trans_439"].substation_name == None # ''
    ...
    assert m["tr(r:p4udt27-p4udt27lv)"].is_substation == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)"].normhkva == 82.5
    assert m["tr(r:p4udt27-p4udt27lv)"].install_type == None
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)"].positions == None # []
    assert m["tr(r:p4udt27-p4udt27lv)"].is_center_tap == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)"].substation_name == None # ''
    ...
    assert m["tr(r:p4udt27-p4udt27lv)_1"].is_substation == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].normhkva == 82.5
    assert m["tr(r:p4udt27-p4udt27lv)_1"].install_type == None
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].positions == None # []
    assert m["tr(r:p4udt27-p4udt27lv)_1"].is_center_tap == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_1"].substation_name == None # ''
    ...
    assert m["tr(r:p4udt27-p4udt27lv)_2"].is_substation == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].normhkva == 82.5
    assert m["tr(r:p4udt27-p4udt27lv)_2"].install_type == None
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].positions == None # []
    assert m["tr(r:p4udt27-p4udt27lv)_2"].is_center_tap == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_2"].substation_name == None # ''
    ...
    assert m["tr(r:p4udt27-p4udt27lv)_3"].is_substation == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].normhkva == 82.5
    assert m["tr(r:p4udt27-p4udt27lv)_3"].install_type == None
    ...
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].positions == None # []
    assert m["tr(r:p4udt27-p4udt27lv)_3"].is_center_tap == 0
    #    assert m["tr(r:p4udt27-p4udt27lv)_3"].substation_name == None # ''
    ...
    assert m["tr(r:p4udt25-p4udt25lv)"].is_substation == 0
    assert m["tr(r:p4udt25-p4udt25lv)"].normhkva == 27.5
    assert m["tr(r:p4udt25-p4udt25lv)"].install_type == None
    ...
    # assert m["tr(r:p4udt25-p4udt25lv)"].positions == None # []
    assert m["tr(r:p4udt25-p4udt25lv)"].is_center_tap == 1
    # assert m["tr(r:p4udt25-p4udt25lv)"].substation_name == None # ''
    ...
    assert m["t21396254a"].is_substation == 0
    #    assert m["t21396254a"].normhkva == None # 16.5
    assert m["t21396254a"].install_type == None
    ...
    # assert m["t21396254a"].positions == None # []
    assert m["t21396254a"].is_center_tap == 1
    # assert m["t21396254a"].substation_name == None # ''
    ...
    assert m["feeder_rega"].is_substation == 0
    #    assert m["feeder_rega"].normhkva == None # 30250.0
    assert m["feeder_rega"].install_type == None
    ...
    # assert m["feeder_rega"].positions == None # []
    assert m["feeder_rega"].is_center_tap == 0
    # assert m["feeder_rega"].substation_name == None # ''
    ...
    assert m["5865228330a-1abc"].is_substation == 0
    assert m["5865228330a-1abc"].normhkva == 2000.01
    assert m["5865228330a-1abc"].install_type == None
    ...
    #    assert m["5865228330a-1abc"].positions == None # []
    assert m["5865228330a-1abc"].is_center_tap == 0
    #    assert m["5865228330a-1abc"].substation_name == None # ''
