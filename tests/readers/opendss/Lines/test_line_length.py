...
def test_line_length():
    ...
    # assert len(m["line9"].wires) == 3 # Number of wires # Neutral wire is not counted. TBD
    # Phases of the different wires
    ...
    #    assert m["line9"].is_banked is None # Not implemented for now
    assert m["line9"].faultrate == 0
    #    assert m["line9"].positions is None  # Not implemented for now
    ...
    # assert m["line9"].substation_name is None  # Not implemented for now
    assert m["line9"].feeder_name == "sourcebus_src"
    assert m["line9"].is_recloser is None
    assert m["line9"].is_breaker is None
    # assert m["line9"].is_sectionalizer is None  # Not implemented for now
    assert m["line9"].nameclass == ""
    #    assert m["line9"].is_substation == 0  # Not implemented for now
    #    assert m["line9"].is_network_protector is None  # Not implemented for now
    ...
    # assert len(m["line10"].wires) == 3 # Number of wires # Neutral wire is not counted. TBD
    # Phases of the different wires
    # assert set([w.phase for w in m["line1"].wires]) == set(["A", "B", "C"])
    ...
    #    assert m["line10"].is_banked is None # Not implemented for now
    assert m["line10"].faultrate == 0.1
    #    assert m["line10"].positions is None  # Not implemented for now
    ...
    # assert m["line10"].substation_name is None  # Not implemented for now
    assert m["line10"].feeder_name == "sourcebus_src"
    assert m["line10"].is_recloser is None
    assert m["line10"].is_breaker is None
    # assert m["line10"].is_sectionalizer is None  # Not implemented for now
    assert m["line10"].nameclass == ""
    #    assert m["line10"].is_substation == 0  # Not implemented for now
    #    assert m["line10"].is_network_protector is None  # Not implemented for now
    ...
    # assert len(m["line11"].wires) == 3 # Number of wires # Neutral wire is not counted. TBD
    # Phases of the different wires
    # assert set([w.phase for w in m["line1"].wires]) == set(["A", "B", "C"])
    ...
    #    assert m["line11"].is_banked is None # Not implemented for now
    assert m["line11"].faultrate == 1.0
    #    assert m["line11"].positions is None  # Not implemented for now
    ...
    # assert m["line11"].substation_name is None  # Not implemented for now
    ...
    # assert m["line11"].is_sectionalizer is None  # Not implemented for now
    #    assert m["line11"].is_substation == 0  # Not implemented for now
    #    assert m["line11"].is_network_protector is None  # Not implemented for now
