                        ...
                        if config_name == config_name1:
                            try:
                                ...
                                if conn == 5 or conn == 'SINGLE_PHASE_CENTER_TAPPED':
                                    ...
                                    winding2.phase_windings[
                                        0
                                    ].phase = 'A' #Assume that only one phase from A/B/C was assigned to the winding. TODO replace with 2 to represent secondaries.
                    ...
                    for api_wire in conductors:
                        ...
                        try:
                            if api_line.length is not None:
                                api_wire.resistance = float(conductor['resistance']
                                                            ) * api_line.length / 1609.34 # since we converted the length to m already
                        except AttributeError:
                            pass
                        ...
                        if n_entries == 4: # make longest side on bottom to form a triangle
                            ...
                            for w in conductors:
                                ...
                                if i != max_to and i != max_from:
                                    ...
                                    heron_area = heron_s * (heron_s - max_dist) * (heron_s - distances[i][max_to]
