        ...
        #                        resistance = 0.001
            ...
            # TO-DO FOR 3-WINDING TRANSFORMER
                                if w == 0:
                                    try:
                                        if len(ph1) == 1:
                                            windings[w].nominal_voltage = float(PTXFRM_DPRIKV[int(PTXFRM_IPTROW.index(iptr_wdg))])*10**3
                                        else:
                                             windings[w].nominal_voltage = float(PTXFRM_DPRIKV[int(PTXFRM_IPTROW.index(iptr_wdg))])*10**3*pow(3,0.5)
                                        windings[w].rated_power = float(PTXFRM_DNOMKVA[int(PTXFRM_IPTROW.index(iptr_wdg))])*10**3
                                ...
                                if w == 1:
                                    try:
                                        if len(ph1) == 1:
                                            windings[w].nominal_voltage = float(PTXFRM_DSECKV[int(PTXFRM_IPTROW.index(iptr_wdg))])*10**3
                                        else:
                                            windings[w].nominal_voltage = float(PTXFRM_DSECKV[int(PTXFRM_IPTROW.index(iptr_wdg))])*10**3*pow(3,0.5)
                                        windings[w].rated_power = float(PTXFRM_DNOMKVA[int(PTXFRM_IPTROW.index(iptr_wdg))])*10**3
                                        if num_windings == 3:
