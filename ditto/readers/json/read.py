...
'''
        ...
        ditto_klasses=['PowerSource','Node','Line','Winding','PowerTransformer','Position',
                       'Wire','PhaseWinding','Load','PhaseLoad','Capacitor','PhaseCapacitor']
            ...
            for object_property,property_value in _object.iteritems():
                ...
                if object_property!='klass':
                    ...
                    if property_type=='list':
                        ...
                        for element in property_value['value']:
                                ...
                                for element_property,element_value in element.iteritems():
                                    ...
                                    if element_property!='klass':
                                        ...
                                        if nested_element_type=='list':
                                            ...
                                            for element_deep in element_value['value']:
                                                ...
                                                if element_deep_class in ditto_klasses:
                                                    ...
                                                    for nested_object_property,nested_object_property_value in element_deep.iteritems():
                                                        ...
                                                        if nested_object_property!='klass':
                                                            ...
                                                            if nested_object_property_value['klass']=='complex':
                                                                ...
                                                                setattr(api_object_two_level_deep, nested_object_property,
                                                                        complex(nested_object_property_value['value'][0],
                                                            ...
                                                            #...or a standard type
                                                                ...
                                                                setattr(api_object_two_level_deep, nested_object_property,
                                                                        eval(nested_object_property_value['klass'])(nested_object_property_value['value']))
                                                    ...
                                                    list_second_level.append(complex(element_deep['value'][0],
                                        ...
                                        #Or, it could be a complex number
                                            ...
                                            setattr(api_object_one_level_deep, element_property,
                                                    complex(element_value['value'][0],
                                        ...
                                        #Or, None or standard types
                                            ...
                                            setattr(api_object_one_level_deep, element_property,
                                                    eval(nested_element_type)(element_value['value']))
                            ...
                            #If it is a list, this should be a matrix stored as a list of lists
                                ...
                                for element_deep in element['value']:
                                    ...
                                    if element_deep['klass']=='complex':
                                        ...
                                        inner_list.append(complex(element_deep['value'][0],
                                                                  element_deep['value'][1]))
                            ...
                            #Or, it could be a complex number (handled in a list format)
                                ...
                                list_first_level.append(complex(element['value'][0],
                                                                element['value'][1]))
                    ...
                    #the representation used is a list [nb.real,nb.imag]
                        ...
                        setattr(api_object, object_property, complex(property_value['value'][0],
