...
class PhaseLoad(DiTToHasTraits):
    ...
    use_zip = Int(
        help=
        '''Describes whether the load is reprsented as a zipload or not. 1 represents zipload with fractions taken from the p and q values above.  0 represents a load defined by  p & q alone.''',
        default_value=0
    )
