...
class Wire(DiTToHasTraits):
    ...
    emergency_ampacity = Float(help='''The ampacity rating for the wire under emergency conditions''', default_value=None)
    resistance = Float(help='''The total resistance of the wire''', default_value=None)
    insulation_thickness = Float(help='''Thickness of the insulation around the secondary live conductors''', default=None)
    is_fuse = Int(help='''This flag indicates whether or not this wire is also a fuse''', default_value=None)
    is_switch = Int(help='''This flag indicates whether or not this wire is also a switch''', default_value=None)
    is_open = Int(help='''This flag indicates whether or not the line is open (if it is a switch/fuse)''', default_value=None)
    fuse_limit = Float(help='''The maximum current that can pass through the wire before the fuse blows''', default_value=None)
    concentric_neutral_gmr = Float(help='''The geometric mean radius of the neutral for a concentric wire''', default_value=None)
    concentric_neutral_resistance = Float(help='''The total resistance of the neutral for a concentric wire''', default_value=None)
    concentric_neutral_diameter = Float(help='''The diameter of the neutral for a concentric wire''', default_value=None)
    ...
    is_recloser = Int(help='''This flag indicates whether or not this wire is also a recloser''', default_value=None)
