...
class WeatherLayer(DiTToHasTraits):
    ...
    positions = List(Instance(Position), help='''This parameter is a list of positional points describing the weather data. The positions are objects containing elements of long, lat and elevation (See Position object documentation).''')
