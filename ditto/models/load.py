...
class Load(DiTToHasTraits):
    ...
    connecting_element = Unicode(help='''Name of the bus to which the load is connected''', default_value=None)

    #Modification: Claudio (August 2017)
    rooftop_area = Float(help='''This parameter is the rooftop area for all phases of the load''', default_value=None)
    peak_p = Float(help='''This parameter is the annual peak p value of all combined phases of the load''', default_value=None)
    peak_q = Float(help='''This parameter is the annual peak q value of all combined phases of the load''', default_value=None)
    peak_coincident_p = Float(help='''This parameter is the annual coincident peak p value of all combined phases of the load''', default_value=None)
    peak_coincident_q = Float(help='''This parameter is the annual coincident peak q value of all combined phases of the load''', default_value=None)
    yearly_energy = Float(help='''This is the total energy used by the load across all phases over a typical year''', default_value=None)
