...
project = u'DiTTo'
copyright = u"2018, Alliance for Sustainable Energy"
author = u''
...
latex_documents = [
    (master_doc, 'DiTTo.tex', 'DiTTo Documentation',
     '', 'manual'),
]
...
man_pages = [(master_doc, 'ditto', 'DiTTo Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'DiTTo', 'DiTTo Documentation', author, 'DiTTo', 'Distribution system Transformation Tool.', 'Miscellaneous'),
]
